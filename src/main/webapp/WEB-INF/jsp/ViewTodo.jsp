...
<body>
    ...
    <div class="container">
            	...
            	<c:forEach var="todo" items="${list}">
                    <tr>
                		...
                		<td><button type="button" class="btn btn-success">
                		    <a href="/todoList/updateTodoItem/${todo.id}">Mark Complete</a>
                		</button></td>
                		<td><button type="button" class="btn btn-primary">
                		    <a href="/todoList/editTodoItem/${todo.id}">Edit</a>
                		</button></td>
                		<td><button type="button" class="btn btn-danger">
                			<a href="/todoList/deleteTodoItem/${todo.id}">Delete</a>
                		</button></td>
                	</tr>
        ...
        <button type="button" class="btn btn-primary btn-block">
        	<a href="/todoList/addTodoItem">Add New ToDo Item</a>
        </button>
